...
\begin{table}[t]
\centering\small
\caption{nDCG@10 with 95\% bootstrap CI. \textbf{Bold} = best per column. $\dagger$ = 95\% CI of diff vs Cross-Enc excludes 0. $\ddagger$ = JKO and KL-Prox are within CI of each other (effectively tied).}
\label{tab:main}
...
\midrule
\jko\ (ours)  & \textbf{0.713}$^\dagger$ & \textbf{0.359}$^\dagger$ & \textbf{0.726}$^\dagger$ & 0.411$^{\dagger\ddagger}$ & 0.196$^{\dagger\ddagger}$ \\
